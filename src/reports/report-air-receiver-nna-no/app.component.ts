...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  private AR_MANUFACTURER = '';
  private AR_PRODUCTION_YEAR = '';
  private AR_VOLUME = '';
  private AR_CERTIFICATE = '';
  private AR_POSITION = '';
  private AR_PREVIOUS_WATER_PRESSURE = '';
  private AR_CE_TANK = '';
  private AR_STANDARD = '';
  private AR_CHECK_DONE = '';
  private AR_EXTERNAL_CHECK = '';
  private AR_SAFETY_VALVE_CHECK = '';
  private AR_MANO_CHECK = '';
  private AR_WATER_PRESSURE = '';
  private AR_MEASURED_THICKNESS_SHELL = '';
  private AR_ALLOWED_THICKNESS_SHELL = '';
  private AR_MEASURED_THICKNESS_BOTTOM = '';
  private AR_ALLOWED_THICKNESS_BOTTOM = '';
  private AR_CONDENSATION_CONTROL = '';
  private AR_SIGNED = '';
  private AR_APPROVED_NAPPROVED = '';
