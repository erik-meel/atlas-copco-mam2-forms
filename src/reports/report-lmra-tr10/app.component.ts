...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  onCustomerSignatureEnd(): void {
    this.customerSignatureDate = (new Date()).toLocaleString('TR-tr', this.formService.dateTimeFormat);
  ...
  onTechSignatureEnd(): void {
    this.techSignatureDate = (new Date()).toLocaleString('TR-tr', this.formService.dateTimeFormat);
    this.formService.saveHtmlToMel();
  }
