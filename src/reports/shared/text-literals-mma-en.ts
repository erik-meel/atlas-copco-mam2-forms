export var textLiterals = {
  ...
  'VISIT_REPORT': 'Visit Report',
   ...
   'COMPANY_GROUP_NAME': 'Atlas Copco Services Myanmar Co.,Ltd.',

   'COMPANY_LEGAL_NAME': 'Post address:',

   'COMPANY_ADDRESS_1': 'Mimosa Building, 1st Floor, No.196, West Shwe Gong Daing, ',

   'COMPANY_ADDRESS_2': '5th Street, Bahan Township, Yangon',

   'VISITORS_ADDRESS': 'Visitor Address:',

   'VISITOR_ADDRESS_1': 'Mimosa Building, 1st Floor, No.196, West Shwe Gong Daing, ',

   'VISITOR_ADDRESS_2': '5th Street, Bahan Township, Yangon',

   'FOOTER_CENTER_LINE1': 'Phone: +951 380873 ',

   'COMPANY_FAX': 'Fax: +951 380873',
   ...
   'FOOTER_ADDITIONAL_INFO_3': 'CT Reg No: 114129526',
