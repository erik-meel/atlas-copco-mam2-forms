export var textLiterals = {
  ...
  'COMMISSION_REPORT': 'Bezoekrapport',
  'LMRA_REPORT': 'Safety First',
  'SMARTBOX_REPORT': 'Bezoekrapport',
  'SPM_REPORT': 'Bezoekrapport',
  'TIME_CONFIRMATION_REPORT': 'Tijdverantwoording',
  ...
  'PO_NUMBER': 'PO number',
  'WORK_COMMENTS': 'Uitgevoerde werkzaamheden & Bevindingen',
  ...
  'TIME_CONFIRMATION': 'Tijd en km verantwoording',
  'DATE': 'Datum',
  ...
  'PLEASE_ENTER_YOUR': 'Vul uw naam hier in',
  'SIGNED_BY': 'Getekend door',
  'AT': 'op',
  'BEING_DULY_AUTHORISED': '(Gemachtigd voor ondertekening)',

  'SAFETY_FIRST': 'VEILIGHEID EERST', //translated 6-5-2020
  'QUESTION': 'Vraag', //translated 6-5-2020
  'CHECKED': 'Gecontroleerd', //translated 6-5-2020
